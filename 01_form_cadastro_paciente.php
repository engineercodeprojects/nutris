    ...
    <div class="row">
          ...
          <!-- inicio - linha 3 --> 
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="cep" id="cep" placeholder="18.132-852">
              </div>
              <!-- fim CEP -->
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="telefone_residencial" id="telefone_residencial" placeholder="(11)4712-8523">
              </div>
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="telefone_comercial" id="telefone_comercial" placeholder="15)3235-9632">
              </div>
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="celular" id="celular" placeholder="(11)99999-8877">
              </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body borda_verde_claro" style="border-left:5px solid #0A4438">
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_atividade_fisica" id="opt_atividade_fisica" value="1" onclick="preencher_campo_sim_nao(1, 'atividade_fisica', 'Pratica ')" checked>
                        Sim
                      </label>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_atividade_fisica" id="opt_atividade_fisica" value="2" onclick="preencher_campo_sim_nao(2, 'atividade_fisica', 'Nenhuma ')">
                        Não
                      </label>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="atividade_fisica" id="atividade_fisica" placeholder="">
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_fumante" id="opt_fumante" value="S" onclick="preencher_campo_sim_nao(1, 'fumante', 'Fuma ')" checked>
                        Sim
                      </label>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_fumante" id="opt_fumante" value="N" onclick="preencher_campo_sim_nao(2, 'fumante', 'Nenhum')">
                        Não
                      </label>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" name="fumante" id="fumante" placeholder="15">
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="radio-inline">
                          <label>
                            <input type="radio" name="bebida_alcoolica" id="bebida_alcoolica" value="S" onclick="alterar_combo(1, 'frequencia_bebida_alcoolica', '0')" checked>
                            Sim
                          </label>
                        </div>
                        ...
                        <div class="radio-inline">
                          <label>
                            <input type="radio" name="bebida_alcoolica" id="bebida_alcoolica" value="N" onclick="alterar_combo(2, 'frequencia_bebida_alcoolica', '4')">
                            Não
                          </label>
                        </div>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_incomodo_gastrointestinal" id="opt_incomodo_gastrointestinal" onclick="preencher_campo_sim_nao(1, 'incomodo_gastrointestinal', 'Possui ')" value="S" checked>
                        Sim
                      </label>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_incomodo_gastrointestinal" id="opt_incomodo_gastrointestinal"  onclick="preencher_campo_sim_nao(1, 'incomodo_gastrointestinal', 'Não possui ')" value="N">
                        Não
                      </label>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" class="form-control" name="incomodo_gastrointestinal" id="incomodo_gastrointestinal" placeholder="Intolerância a Lactose">
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_medicamento_suplemento" id="opt_medicamento_suplemento"  onclick="preencher_campo_sim_nao(1, 'medicamento_suplemento', 'Possui ')" value="S" checked>
                        Sim
                      </label>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_medicamento_suplemento" id="opt_medicamento_suplemento" onclick="preencher_campo_sim_nao(2, 'medicamento_suplemento', 'Não possui ')" value="N">
                        Não
                      </label>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" class="form-control" name="medicamento_suplemento" id="medicamento_suplemento" placeholder="Intolerância a Lactose">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                    <label for="medicamento_por_doenca">Medicamento recomendando por doença?</label>
                    <br/>
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_medicamento_por_doenca" id="opt_medicamento_por_doenca" value="S" onclick = "preencher_campo_sim_nao(1, 'medicamento_por_doenca', 'Faz uso de ')" checked>
                        Sim
                      </label>
                    </div>
                    ...
                    <div class="radio-inline">
                      <label>
                        <input type="radio" name="opt_medicamento_por_doenca" id="opt_medicamento_por_doenca"  onclick = "preencher_campo_sim_nao(1, 'medicamento_por_doenca', 'Não faz uso de medicamento por doença específica ')" value="N">
                        Não
                      </label>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-md-9">
                        ...
                        <input type="text" class="form-control" name="medicamento_por_doenca" id="medicamento_por_doenca" placeholder="Losartana">
                    </div>
