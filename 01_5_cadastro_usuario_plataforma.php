        ...
        <!-- fim - linha 0 -->
          ...
          <!-- inicio - linha 1 -->
              ...
              <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control" name="nome_usuario" id="nome_usuario" placeholder="Maria da Silva" maxlength="100" required>
              </div>
              <!-- fim nome usuario -->
    ...
    <!-- fim - painel dados pessoais -->
        ...
        <!-- inicio - botao para Salvar Usuário -->
              <div class="col-md-12  direito">
                <button type="submit" class="btn btn_verde_claro"> Salvar Usuário </button>    
