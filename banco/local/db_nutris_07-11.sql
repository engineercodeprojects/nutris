...
--
-- Host: localhost:3306
-- Generation Time: 06-Nov-2017 às 05:30
...
(6, 'Jhames', 'jhames_cobello', 'jh@2017', 1, 1),
(7, 'Alessandra', 'alessandra_cobello', 'al@2017', 1, 1),
(8, 'Giovana', 'giovana_cobello', 'gc@2017', 1, 1),
(17, 'irani', 'irani_loureiro', 'nutris@2017', 1, 1);
...
--
ALTER TABLE `tb_usuario`
  MODIFY `cod_usuario` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
