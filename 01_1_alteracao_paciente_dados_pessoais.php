...
<div class="container-fluid">
   ...
   <div class="col-md-offset-1 col-md-10">
    ...
    <div class="row">
        <!-- inicio - painel dados pessoais -->
          <div class="panel panel-default margin_top_20 sem_borda">
            <div class="panel-body borda_verde_escuro col-md-8" style="border:0px solid #eee; border-left:0px solid #0A4438;">                 
                    <span class="glyphicon glyphicon-edit fonte_verde_claro"></span>
                    <span class=" fonte_verde_claro fonte_muito_grande negrito">ATUALIZAÇÃO PACIENTE</span>
                    <br/>
                    <span class="fonte_pequena">Dados Pessoais</span>                
            </div>
              
            <div class="col-md-4 direito fonte_pequena">
                <br/><br/>
                <a href="01_1_cadastro_paciente_antopometria.php" alt="Antopometria" title="Antopometria">
                Antopometria <span class="glyphicon glyphicon-chevron-right">
                </a>
            </div>
    ...
    <button type="submit" class="btn btn-primary">Atualizar Dados Paciente</button>    
    </div>
   ...
   <!-- inicio da div que envolve todo conteúdo da página centralizando o conteudo - 1 coluna a esquerda e 1 coluna a esquerda --> 
    ...
    if( $_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        $titulo = "Atualização de  Paciente - Dados Pessoais";
        $mensagem = "Os dados pessoais de " . $nome_paciente . " foram cadastrados com sucesso!";
