        ...
        <div class="well fundo_transparente fonte_verde_claro sem_borda col-md-offset-1 col-md-10">
            ...
            <div class="col-md-1">
                ...
                if($dados_historico_paciente['foto_paciente'] != 'avatar_masculino.png' and $dados_historico_paciente['foto_paciente'] != 'avatar_feminino.png')
                    print "<img src='fotos/" . $dados_historico_paciente['foto_paciente'] . "' width='120' height='120' class='img-responsive margin_auto'>";
            ...
            <div class="col-md-3 text-uppercase centralizado fundo_verde_claro fonte_branca padding_20">
                ...
                <div class="col-md-9 esquerdo">
                    ...
                    <span class=" fonte_icone_sucesso fonte_branca  fonte_muito_grande">
                        <?php 
                        //recuperando a data da última anamnese
                        $sqlstring_ultima_anamnese  = "select tb_historico_paciente.data_historico_paciente from tb_historico_paciente ";                        
                        $sqlstring_ultima_anamnese .= "where tb_historico_paciente.cod_paciente = " . $_SESSION['cod_paciente_selecionado'];
                        $sqlstring_ultima_anamnese .= " order by cod_historico_paciente desc limit 1";
                        $info_ultima_anamnese = $db->sql_query($sqlstring_ultima_anamnese);
                        $dados_ultima_anamnese = mysql_fetch_array($info_ultima_anamnese);
                        list($ano, $mes, $dia) = explode('-', $dados_ultima_anamnese['data_historico_paciente']);
                        print  $dia."/".$mes."/".$ano ;
                        ?>
                    </span>                                        
                </div> 
