        ...
        <div class="well fundo_transparente fonte_verde_claro sem_borda col-md-offset-1 col-md-10">
            ...
            <div class="col-md-1">
                ...
                if($dados_objetivo_programa['foto_paciente'] != 'avatar_masculino.png' and $dados_objetivo_programa['foto_paciente'] != 'avatar_feminino.png')
                    print "<img src='fotos_usuarios/" . $dados_objetivo_programa['foto_paciente'] . "' width='120' height='120' class='img-responsive margin_auto'>";
            ...
            <div class="col-md-3 text-uppercase centralizado fundo_verde_claro fonte_branca padding_20">
                ...
                <div class="col-md-9 esquerdo">
                    ...
                    <span class=" fonte_icone_sucesso fonte_branca  fonte_muito_grande">
                        <?php 
                        list($ano, $mes, $dia) = explode('-', $dados_objetivo_programa['data_objetivo_paciente']);
                        print  $dia."/".$mes."/".$ano ;
                        ?>
                    </span>                                        
                </div> 
