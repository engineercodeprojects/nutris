                ...
                <div id="grupo_alim" name="grupo_alim" class="form-group col-md-6">
                    ...
                    <select name="grupo_alimentos" id="grupo_alimentos" class="form-control text-uppercase">
                      <?php
                        ...
                        {
                            if($dados_grupo['cod_grupo'] == $dados_alimento_selecionado['cod_grupo'])
                                print "<option value=" . $dados_grupo['cod_grupo'] . " selected>" . $dados_grupo['grupo'] . " - " . $dados_grupo['descricao_grupo'] .  "</option>";
                            else
